...
pd.pivot_table(
    ...
    index=[
        ...
        "col2",
        "col3",
    ],  # these stay as columns; will fail silently if any of these cols have null values
    columns=["col4"],
)  # data values in this column become their own column
...
df["new_col1"], df["new_col2"] = zip(
    *df["original_col"].apply(lambda x: x.split(": ", 1))
)
