...
WHERE month = 1                     -- =, !=, >, <, >=, <=
    ...
    OR 'day' LIKE '[mtw]%day'       -- [charlist] Set range of characters to match eg. [abc] or [a-c]
...
-- PERMISSIONS
    ...
    # He/she can SELECT from that table until everyone who granted the permission revokes it. 
    # You cannot REVOKE privileges not initially granted by you.
